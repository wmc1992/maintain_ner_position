...
def insert_entity(content, entity_list, insert_idx, insert_content, insert_type):
    """
    ...
    entity_list.append({
        "type": insert_type,
        "start": insert_idx,
        "end": insert_idx + len(insert_content),
        "value": content[insert_idx:insert_idx + len(insert_content)],
    })
...
def insert_content(content, entity_list, insert_idx, insert_content):
    ...
    for e in entity_list:
        if e["start"] >= insert_idx:
            e["start"] += len(insert_content)
        if e["end"] > insert_idx:
            e["end"] += len(insert_content)

    content = content[:insert_idx] + insert_content + content[insert_idx:]
...
def insert_entity_extend_entity(content, entity_list, insert_idx, insert_content, insert_type):
    """
